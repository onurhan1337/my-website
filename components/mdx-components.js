...
function ul(props) {
    return <ul className="list-inside list-disc space-y-2 marker:text-gray-600 dark:text-gray-200" {...props} />
}

function li(props) {
    return <ul className="text-gray-800 dark:text-gray-700" {...props} />
}
function ol(props) {
...
function h3(props) {
    return <h3 className="text-gray-800 !mb-2 text-xl font-semibold leading-tight" {...props} />
}
