...
const TimelineItem = ({ experiences }) => {
    ...
    <div className="container px-5 py-24 mx-auto flex flex-wrap">
        ...
        <div key={experience.id} className="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
            ...
            <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                <div
                    className="flex-shrink-0 w-18 h-18 bg-gray-50 text-indigo-500 inline-flex items-center justify-center">
                    <img className="w-14 h-14 rounded-xl" src={experience.companyLogo ? experience.companyLogo : undefined} />
                </div>
                <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                    ...
                    <p className="leading-relaxed">{experience.title}</p>
                </div>
            </div>
        </div>
        ))}
