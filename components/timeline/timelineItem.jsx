    ...
    <div className="container px-5 py-24 mx-auto flex flex-wrap">
        ...
        <div key={experience.id}  className="flex relative pt-10 pb-10 sm:pb-20 sm:items-center md:w-2/3 sm:mx-auto">
            <div className="h-full w-6 absolute inset-0 flex items-center justify-center">
                <div className="h-full w-1 bg-gray-200 dark:bg-zinc-700 pointer-events-none"></div>
            </div>
            <div
                ...
                <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                    <div className="flex flex-row">
                        <Link href={experience.link} target="_blank" >
                            <h2 className="font-semibold title-font text-gray-900 dark:text-zinc-300 mb-1 text-xl">{experience.company}</h2>
                        </Link>
                        <ArrowUpRight className="ml-1" src="photos/arrow-up-right.svg" />
                    </div>
                    <p className="leading-relaxed break-words dark:text-zinc-500">{experience.title}</p>
