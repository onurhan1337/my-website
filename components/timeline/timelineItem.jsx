...
const TimelineItem = ({ data }) => {
  return (
    <div className="container py-24 mx-auto">
      <h1 className="font-bold text-3xl border-2 rounded-full text-center border-green-300 py-2 text-gray-600 decoration-green-400 dark:text-stone-400">
        Work
      </h1>
      <div>
        <div className="flex flex-col mt-4">
          {data.map((data) => (
            ...
            >
              <div>
                <p className="text-gray-400 dark:text-stone-700">
