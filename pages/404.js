  ...
  return (
    <div className="flex flex-col m-auto justify-center items-center text-center">
        <div className="my-2 mx-4">
          ...
          <p className="text-black dark:text-stone-200">The page you were looking for <span className="font-bold underline">could not</span> be found.</p>
          <p className="text-black dark:text-stone-200">To return to the Home Page,</p>
          <Button className={" bg-[#100F0F] hover:ring-black dark:bg-[#458766] dark:text-black mt-2"}>Go Home</Button>
        </div>
