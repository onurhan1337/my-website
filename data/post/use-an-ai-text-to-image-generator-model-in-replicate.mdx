...
subtitle: "A Comprehensive Guide to AI Text-to-Image Generation in Replicate with Next.js and TypeScript."
tweetUrl: "https://onurhan.dev/post/use-an-ai-text-to-image-generator-model-in-replicate"
---
...
<img
  ...
  src="/static/blogs/console_output.webp"
  alt="Console Output"
/>
...
<img
  className="w-full rounded-md"
  src="/static/blogs/replicate_generated_image.webp"
  alt="Console Output"
/>

We got our first output by running the text-to-image generator model. See you in
my next article ✨
